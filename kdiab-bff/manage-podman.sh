...
# Manage Podman environments for kdiab-bff
...
case "$1" in
    ...
    cleanup)
        ...
        echo "=> Cleaning up generated podman images for kdiab-bff..."
        podman images | grep "kdiab-bff" | awk '{print $3}' | xargs -r podman rmi -f
