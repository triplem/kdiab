...
group = "org.javafreedom.kdiab.bff"
version = "0.1.0"
...
dependencies {
    ...
    // Ktor Client (for calling upstream services)
...
application {
    mainClass.set("org.javafreedom.kdiab.bff.ApplicationKt")
}
...
openApiGenerate {
    ...
    packageName.set("org.javafreedom.kdiab.bff.api")
    apiPackage.set("org.javafreedom.kdiab.bff.api")
    modelPackage.set("org.javafreedom.kdiab.bff.api.models")
...
kover {
    reports {
        filters {
            excludes {
                classes(
                    "org.javafreedom.kdiab.bff.ApplicationKt*"
                )
                packages(
                    "org.javafreedom.kdiab.bff.api",
                    // Adapters require live Ktor test engine or running upstream services;
                    // covered by integration/e2e tests, not unit tests
                    "org.javafreedom.kdiab.bff.adapters.inbound.web",
                    "org.javafreedom.kdiab.bff.adapters.outbound.http",
                    // Ktor plugins require a running server to test
                    "org.javafreedom.kdiab.bff.plugins",
                    // Exception data classes have no logic to measure
                    "org.javafreedom.kdiab.bff.domain.exception"
                )
            }
        }
