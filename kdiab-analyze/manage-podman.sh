...
# Manage Podman environments for kdiab-analyze
...
case "$1" in
    ...
    cleanup)
        ...
        echo "=> Cleaning up generated podman images for kdiab-analyze..."
        podman images | grep "kdiab-analyze" | awk '{print $3}' | xargs -r podman rmi -f
