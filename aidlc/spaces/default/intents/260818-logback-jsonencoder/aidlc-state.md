...
## Project Information
- **Project**: Replace logback-contrib JacksonJsonFormatter + jackson with Logback's built-in JsonEncoder across all 8 backends; retire the jackson CVE force-pins (issue #1556)
- **Project Type**: Brownfield
- **Scope**: refactor
- **Start Date**: 2026-08-18T18:05:45Z
- **State Version**: 7
...
- **Next Stage**: none
- **Status**: Running
- **Last Updated**: 2026-08-18T18:42:01Z
