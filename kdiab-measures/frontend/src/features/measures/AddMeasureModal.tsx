...
export const AddMeasureModal: React.FC<AddMeasureModalProps> = ({ isOpen, onClose, onSave, glucoseUnit = 'mg/dL', weightUnit = 'kg', isSaving = false }) => {
  ...
  return (
    ...
    >
      <div
        style={{ background: 'rgba(15, 23, 42, 0.97)', border: '1px solid rgba(255,255,255,0.12)', padding: '24px', borderRadius: '16px', minWidth: '380px', maxWidth: '480px', width: '90%', boxShadow: '0 25px 50px rgba(0,0,0,0.6)' }}
