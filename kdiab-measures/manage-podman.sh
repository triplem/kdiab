...
# Manage Podman environments for kdiab-measures
...
case "$1" in
    ...
    cleanup)
        ...
        echo "=> Cleaning up generated podman images for kdiab-measures..."
        # Find images tagged with 'kdiab-measures' or 'localhost/kdiab-measures' and remove them
        podman images | grep "kdiab-measures" | awk '{print $3}' | xargs -r podman rmi -f
