...
# Manage Podman environments for kdiab-treatments
...
case "$1" in
    ...
    cleanup)
        ...
        echo "=> Cleaning up generated podman images for kdiab-treatments..."
        # Find images tagged with 'kdiab-treatments' or 'localhost/kdiab-treatments' and remove them
        podman images | grep "kdiab-treatments" | awk '{print $3}' | xargs -r podman rmi -f
