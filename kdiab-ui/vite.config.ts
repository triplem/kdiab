  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        // report infrastructure + page presentation components — rendering/composition layers;
        // business logic lives in utility modules and hooks (tested separately)
        'src/features/report/ReportPage.tsx',
        'src/features/report/ReportView.tsx',
        'src/features/report/ReportPageSelector.tsx',
        'src/features/report/DateRangePicker.tsx',
        'src/features/report/useReportData.ts',
        'src/features/report/useReportPageSelection.ts',
